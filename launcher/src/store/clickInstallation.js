      ...
      presets: [
        {
          ...
          icon: "/img/icon/click-installation/staking-preset.png",
        ...
        },
        {
          ...
          name: "ssv.network",
          defaultPath: "/opt/stereum",
          icon: "/img/icon/click-installation/ssv-network-preset.png",
          includedPlugins: [],
        },
        {
          id: 3,
          name: "obol",
          defaultPath: "/opt/stereum",
          icon: "/img/icon/click-installation/obol-charon-preset.png",
          includedPlugins: [],
        },
        {
          id: 4,
          name: "stereum on arm",
          defaultPath: "/opt/stereum",
          icon: "/img/icon/click-installation/stereum-on-arm-preset.png",
          includedPlugins: [],
        },

        {
          ...
          name: "archive",
          defaultPath: "/opt/stereum",
          icon: "/img/icon/click-installation/archive-preset.png",
          includedPlugins: [],
        },
      ],
      services: [
