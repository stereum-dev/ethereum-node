    ...
    return {
      ...
      presets: [
        ...
        },
        {
          ...
          name: "op full node",
          defaultPath: "/opt/stereum",
          icon: "/img/icon/one-click-icons/preset-icons/op-fullnode.png",
          includedPlugins: [],
        },
        {
          id: 10,
          ...
          sepIcon: "/img/icon/one-click-icons/preset-icons/op-eth-sepolia.png",
          includedPlugins: [],
        },
        {
          id: 11,
          name: "op node archive",
          defaultPath: "/opt/stereum",
          icon: "/img/icon/one-click-icons/preset-icons/op-archive.png",
          includedPlugins: [],
        },
        {
          id: 12,
          name: "op and eth node archive",
          defaultPath: "/opt/stereum",
          icon: "/img/icon/one-click-icons/preset-icons/op-eth-archive.png",
          includedPlugins: [],
        },
      ],
      services: [
