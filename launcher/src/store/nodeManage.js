    ...
    return {
      ...
      networkList: [
        ...
        },
        {
          ...
          currencyIcon: "/img/icon/network-currency-icons/network-currency-icons-goerli-testnet.png",
        ...
        },
        {
          ...
          currencyIcon: "/img/icon/network-currency-icons/network-currency-icons-gnosis-mainnet.png",
