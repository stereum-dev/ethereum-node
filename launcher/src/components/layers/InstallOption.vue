<template>
    <div class="parent">
        ...
        <div class="container">
            <div class="text">
                ON THIS PAGE YOU CAN CHOOSE WHAT YOU WANT TO DO WITH YOUR NODE. AFTER CHOOSING AND PRESSING START A RANDOM CLIENT SELECTION WILL BE TAKEN TO SERVE YOUR USE CASE
            </div>
            <hr />
            <ul class="row">
