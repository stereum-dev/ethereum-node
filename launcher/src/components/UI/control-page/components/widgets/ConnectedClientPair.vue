    ...
    <div class="val-box flex flex-col w-full h-5/6 justify-start items-center gap-2 p-1">
      <div class="client-type w-full h-1/2 flex">
        ...
        <div class="icon-bar h-full w-6 flex justify-center items-center">
          <img class="w-5 h-5" src="/img/icon/service-icons/validator/Lighthouse-Validator-Circle.png" alt="" />
        </div>
        <span class="client-name w-24 text-gray-200 uppercase text-[50%] flex justify-start items-center pl-2">dummy</span>
      </div>
