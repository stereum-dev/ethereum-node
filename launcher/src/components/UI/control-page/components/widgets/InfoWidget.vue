  ...
  <div class="info-Parent flex w-full h-full justify-center items-center">
    <div class="info-Ico w-1/3 h-full flex flex-col justify-center items-center">
      ...
      <span
        ...
        >{{ $t("controlPage.info") }}</span
      >
    </div>
    <div
      class="info-box gap-1 p-1 w-2/3 h-full flex flex-col justify-center items-center"
    >
      <div
        class="info-row w-full h-1/3 flex justify-center items-center rounded-lg border border-gray-500"
      >
        <div class="w-1/5 h-full flex justify-center items-center">
          <img
            class="w-8/12 h-4/5"
            src="/img/icon/control-page-icons/ubuntuIco.svg"
            alt=""
          />
        </div>
        <div
      ...
      >
        <div
          class="w-1/5 flex h-full font-semibold items-center justify-start pl-2 text-gray-200 uppercase text-xs"
        >
          ip:
        </div>
        <div
      ...
      >
        <div class="w-1/6 h-full flex justify-center items-center">
          <img
            class="w-3/4 h-4/5"
            src="/img/icon/control-page-icons/Earth_Western.png"
            alt=""
          />
        </div>
        <div
        ...
        <div class="w-1/6 h-full flex justify-center items-center">
          <img
            class="w-1/2 h-4/5"
            src="/img/icon/control-page-icons/server-icon-download-icons.png"
            alt=""
          />
        </div>
      </div>
