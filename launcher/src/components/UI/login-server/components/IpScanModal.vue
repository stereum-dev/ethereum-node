...
.ipscan-icon-container img {
  width: 80%;
  height: 100%;
}
.ipscan-text-container {
  margin-top: 1%;
  width: 90%;
  height: 35%;
  display: flex;
