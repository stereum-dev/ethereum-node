<template>
  <div class="w-full h-full absolute inset-0 flex justify-center items-center">
    ...
    >
      ...
      >
        <img class="w-52" src="/img/icon/edit-node-icons/stereum_cant_connect.gif" />
      ...
      <div
        ...
        class="w-full h-full col-start-1 col-span-full row-start-2 row-span-5 flex flex-col justify-evenly items-center"
      >
        <img v-if="reconnecting" class="w-52" src="/img/icon/edit-node-icons/stereum_connected.gif" />
