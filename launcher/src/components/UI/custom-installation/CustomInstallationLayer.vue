<template>
    <div class="custom-layer_parent">
                ...
                <div class="path-container">
                    ...
                    <div class="textbox-cont">
                        <div class="textbox-cont_front">
                            ...
                            <div class="textbox">
                                <input type="text" placeholder="/opt/stereum" v-model="installPath" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <router-link class="back" to="/welcome">{{ $t("installOption.back") }}
        </router-link>
        <router-link @click="prepareStereum" class="install" :class="activeBtn()" to="/node">{{ $t("installOption.install") }}</router-link>
    </div>
</template>
