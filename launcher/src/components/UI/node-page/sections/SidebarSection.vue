<template>
  <aside class="flex flex-col items-center w-18 h-full bg-[#33393E]" @pointerdown.prevent.stop @mousedown.prevent.stop>
    <div class="w-full max-h-[144px] grid grid-rows-3 mt-20 p-1 gap-y-5">
      ...
      >
        <img class="w-7" src="/img/icon/node-icons/edit-node-icon.png" alt="Manage Icon" />
      </div>
      <Transition name="slide-fade">
        ...
        >
          <img class="w-6 mr-1" src="/img/icon/node-icons/edit-node-icon.png" alt="Manage Icon" />
      ...
      <button
        ...
        @mouseleave="footerStore.cursorLocation = ''"
      >
        <img class="w-5" src="/img/icon/node-icons/turn-on.png" alt="Stop Icon" />
      </button>
      ...
      <button
        ...
        @mouseleave="footerStore.cursorLocation = ''"
      >
        <img class="w-5" src="/img/icon/node-icons/turn-off.png" alt="Stop Icon" />
      </button>
      <Transition name="slide-fade">
        <button
        ...
        >
          <img class="w-4 mr-1" src="/img/icon/node-icons/turn-on.png" alt="Stop Icon" />
        ...
        <button
          ...
          @click="showPowerModal"
        >
          <img class="w-4 mr-1" src="/img/icon/node-icons/turn-off.png" alt="Stop Icon" />
      ...
      <Transition name="slide-fade">
        <button
          ...
          @mouseleave="footerStore.cursorLocation = ''"
        >
          <img class="w-5" src="/img/icon/node-icons/export-config-icon.png" alt="Export Icon" />
        </button>
        <button
          v-else
          ...
          @click="exportData"
        >
          <img class="w-4" src="/img/icon/node-icons/export-config-icon.png" alt="Export Icon" />
