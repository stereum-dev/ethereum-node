<template>
  <installation-box :title="title" :back="back" :icon="configClients.icon" @execute-installation="runInstalltion">
        ...
        <div class="table-box">
          <div class="table">
            ...
            <div class="table-content">
              <div v-for="(plugin, index) in configClients" :key="index" class="table-row">
