<template>
  <div class="w-full h-full col-start-1 col-span-full row-start-1 row-span-full grid grid-cols-24 grid-rows-12 p-1">
    ...
    >
      <div
        class="col-start-1 col-span-full row-start-1 row-span-1 bg-teal-600 rounded-md py-1 px-2 grid grid-cols-12 z-10"
      >
        <span
          class="col-start-1 col-end-5 text-sm text-gray-200 font-normal uppercase self-center justify-self-start"
          >{{ $t("importingVerify.pluginInst") }}</span
        >
        <span
          class="col-start-5 col-end-7 text-sm text-gray-200 font-normal uppercase self-center justify-self-start"
          >{{ $t("importingVerify.cat") }}</span
        >
        <span
          class="col-start-7 col-span-full text-sm text-gray-200 font-normal uppercase self-center justify-self-start"
          >{{ $t("importingVerify.path") }}</span
        >
      </div>
      <div
