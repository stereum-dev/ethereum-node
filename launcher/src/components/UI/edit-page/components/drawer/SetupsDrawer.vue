<template>
  ...
  >
    ...
    >
      <div class="w-full h-full rounded-sm bg-red-500 flex justify-center items-center">
        <span class="text-2xs text-center text-gray-100 font-semibold font-sans uppercase mt-1">Return</span>
      </div>
    </div>
    <div
      class="col-start-1 col-span-full row-start-2 row-end-14 w-full h-full bg-[#1d1f21] rounded-md grid grid-cols-2 grid-rows-12"
    >
      <div class="col-start-1 col-span-full row-start-1 row-end-4">
        <span>Add A Setup</span>
      </div>
      <div
        class="col-start-1 col-span-full row-start-4 row-span-full bg-black rounded-md flex flex-col justify-start items-center p-1 overflow-x-hidden overflow-y-auto space-y-1 border border-gray-700"
      >
        <div
    ...
    >
      <span class="text-2xs text-center text-gray-100 font-semibold font-sans uppercase mt-1">Create Custom Setup</span>
