          ...
          >
            ...
            >
              ...
              <div
                ...
                :key="col.name"
                class="w-6 h-6 rounded-full col-span-1 row-start-2 cursor-pointer mx-1 hover:scale-110 transition-all duration-100 hover:shadow-lg hover:shadow-black hover:border hover:border-gray-500 active:scale-95"
                :class="`${col.bg}`"
                @click="getSetupColor(col.name)"
              >
                <input
                  type="radio"
                  name="ColorOption"
...
const colorPalette = [
  { name: "default", bg: "bg-[#336666]" },
  { name: "blue", bg: "bg-blue-500" },
  { name: "red", bg: "bg-red-500" },
  { name: "yellow", bg: "bg-[#F7C566]" },
  { name: "orange", bg: "bg-[#fb923c]" },
  { name: "green", bg: "bg-green-500" },
  { name: "beige", bg: "bg-[#D1BB9E]" },
  { name: "purple", bg: "bg-violet-500" },
  { name: "brown", bg: "bg-[#503C3C]" },
