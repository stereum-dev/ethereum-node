  ...
  <div>
    ...
    >
      <div
        ...
        :class="{
          'bg-green-300 hover:bg-green-300 ': option.isConnected || option.isConnectedToMevBoost,
    ...
    >
      <div
        ...
        class="group mx-auto w-[170px] h-[52px] rounded-md p-1 cursor-pointer hover:bg-blue-300 m-0 active:scale-95 transition duration-200 shadow-xl shadow-[#141516] active:shadow-none"
        :class="{
          'bg-green-300 hover:bg-green-300 ': option.isConnected,
          'bg-[#282a2c]': !option.isConnected,
          'border-2 border-blue-500': option.isSelected,
        }"
        @click="selectService(option)"
    ...
    >
      <div
        ...
        :class="[
          option.isConnectedToSSVNetwork ? 'bg-green-300 hover:bg-green-300' : 'bg-[#282a2c]',
          'row-start-' + (idx + 1),
