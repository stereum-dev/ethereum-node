    ...
    <div class="w-full flex justify-center items-center">
      <div class="w-full grid grid-cols-12 items-center text-md">
        <img
          ...
          src="/img/icon/edit-node-icons/service-save-path.png"
          alt="Path Icon"
        />
        <span class="col-start-2 col-span-3 text-gray-400 text-left">{{
          $t("editModals.installationPath")
        }}</span>
        <input
    ...
    >
      <div class="w-full grid grid-cols-12 items-center text-md">
        <img
          ...
          src="/animation/synchronisation/synchronisation-icon-active.gif"
          alt="Sync Icon"
        />
        <span class="col-start-2 col-span-3 text-gray-400 text-md text-left">{{
          $t("editModals.syncMode")
        }}</span>
