  ...
  <div class="w-full h-full flex flex-col justify-evenly items-center mx-auto px-4 py-2 space-y-2 mt-6 relative">
    <div class="w-full flex justify-center items-center">
      <div class="w-full grid grid-cols-12 items-center text-md">
        <img class="col-start-1 w-8" src="/img/icon/edit-node-icons/folder.png" alt="Path Icon" />
    ...
    >
      <div class="w-full grid grid-cols-12 items-center text-md">
        <img class="col-start-1 w-8" src="/img/icon/edit-node-icons/external-source.png" alt="Path Icon" />
    ...
    >
      <div class="w-full grid grid-cols-12 items-center text-md">
        <img class="col-start-1 w-8" src="/img/icon/edit-node-icons/JWTTokenIcon.png" alt="Path Icon" />
    ...
    <div v-if="client.service === 'ExternalConsensusService'" class="w-full grid grid-cols-12 items-center text-md">
      <img class="col-start-1 w-8" src="/img/icon/edit-node-icons/category.png" alt="Path Icon" />
    ...
    <div v-if="selectedService === 'prysm'" class="w-full grid grid-cols-12 items-center text-md">
      <img class="col-start-1 w-8" src="/img/icon/edit-node-icons/gateway.png" alt="Path Icon" />
