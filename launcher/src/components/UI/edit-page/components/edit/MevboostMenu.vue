...
const emit = defineEmits(["hideMevboost", "confirmMevboost"]);

const hideMevboost = () => {
  emit("hideMevboost", item);
};

const confirmMevboost = () => {
  emit("confirmMevboost", item);
};
</script>
