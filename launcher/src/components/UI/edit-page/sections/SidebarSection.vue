<template>
  <aside class="flex flex-col items-center w-18 h-full bg-[#33393E]" @pointerdown.prevent.stop @mousedown.prevent.stop>
    <div class="w-full grid grid-rows-3 mt-20 p-1 gap-y-5">
      ...
      >
        <img class="w-8 h-5" src="/img/icon/edit-node-icons/backtonode.png" alt="Manage Icon" />
      </div>
      <Transition name="slide-fade">
        ...
        >
          <img class="w-6 h-4 mr-1" src="/img/icon/edit-node-icons/backtonode.png" alt="Manage Icon" />
