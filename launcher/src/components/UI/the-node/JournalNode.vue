<template>
  <div class="config-node">
    ...
    <div v-if="!openLog" class="configBtn">
      ...
      >
        <the-node-panel-btn
          img-path="/img/icon/node-icons/edit-node-icon.png"
          is-color="gold"
          width="20"
          margin-right="1"
      ...
      <the-node-panel-btn
        ...
        img-path="/img/icon/node-icons/turn-on.png"
        is-color="lighGreen"
        width="10"
        margin-right="5"
        btn-action="logToggle"
      ...
      <the-node-panel-btn
        v-else
        img-path="/img/icon/node-icons/turn-off.png"
        is-color="red"
        width="10"
        margin-right="5"
        btn-action="logToggle"
      ...
      >
      <the-node-panel-btn
        img-path="/img/icon/service-logs/log-icon.png"
        is-color="blue"
        width="15"
        margin-right="3"
        btn-action="logToggle"
    ...
    <div v-if="openResync" class="configBtn">
      ...
      >
      <the-node-panel-btn
        img-path="/img/icon/edit-node-icons/back-to-node.png"
        is-color="green"
        width="10"
        margin-right="5"
        btn-action="resyncToggle"
...
export default {
  ...
  data() {
    return {
      ...
      switchIcon: "/img/icon/node-icons/turn-off.png",
