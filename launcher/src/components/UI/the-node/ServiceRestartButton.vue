<template>
  <div class="service-log-button_parent" @click="openRestart">
...
.service-log-button_parent:hover {
  background-color: #18191c;
}
.service-log-button_parent:active {
  box-shadow: none;
