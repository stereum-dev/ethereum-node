    ...
    <div class="col-start-1 col-span-1 self-center overflow-hidden flex justify-start items-center">
      ...
      >
        <img
          ...
          class="w-full h-full"
          src="/img/icon/staking-page-icons/remotekey.svg"
          alt="Key Icon"
          @mousedown.prevent
        />
        <img v-else class="w-full h-full" src="/img/icon/staking-page-icons/key-sign.png" alt="Key Icon" @mousedown.prevent />
      </div>
    </div>
    <div
    ...
    >
      ...
      >
        <img
          ...
          src="/img/icon/staking-page-icons/copy6.png"
          alt="Icon"
          @mousedown.prevent
      ...
      >
        <img
          ...
          src="/img/icon/staking-page-icons/rename-group.png"
          alt="Icon"
          @mousedown.prevent
      ...
      >
        <img
          class="w-5 h-5 hover:scale-105 active:scale-95 cursor-pointer transition-all duration-150"
          src="/img/icon/staking-page-icons/fee-recepient.png"
          alt="Icon"
          @mousedown.prevent
          @click="FeeRecepient"
        />
      ...
      >
        <img
          class="w-5 h-5 hover:scale-105 active:scale-95 cursor-pointer transition-all duration-150"
          src="/img/icon/staking-page-icons/withdraw.png"
          alt="Icon"
          @mousedown.prevent
...
//Key Status Icons
const activeStatusIcon = "/img/icon/staking-page-icons/Validatorkey_Status_Active.png";
const slashedStatusIcon = "/img/icon/staking-page-icons/Validatorkey_Status_Slashed.png";
const depositStatusIcon = "/img/icon/staking-page-icons/Validatorkey_Status_Deposit.png";
const offlineStatusIcon = "/img/icon/staking-page-icons/Validatorkey_Status_Offline.png";
const pendingStatusIcon = "/img/icon/staking-page-icons/Validatorkey_Status_Pending_alternative.png";
const exitedStatusIcon = "/img/icon/staking-page-icons/Validatorkey_Status_Exited.png";
const apiProblems = "/img/icon/staking-page-icons/State_Icon.png";
