<template>
  <div
    class="w-full h-full max-h-6 col-start-1 col-span-full row-span-1 grid grid-cols-6 items-center p-[1px]"
  >
    <div
...
const getObolParticipation = computed(() => {
  if (
    stakingStore.obolStats?.attestationParticipation &&
    stakingStore.obolStats?.operators
  ) {
