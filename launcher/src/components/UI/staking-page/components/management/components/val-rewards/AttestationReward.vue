<template>
  <div
    class="w-full h-full max-h-6 col-start-1 col-span-full row-start-3 row-span-1 border border-gray-600 rounded-full grid grid-cols-6 bg-[#5a6168] items-center p-[1px]"
  >
    <div class="h-full col-start-1 col-end-3 self-center grid grid-cols-3 justify-center items-center gap-1 px-[2px]">
      <img class="col-start-1 col-span-1 w-4 h-4" src="/img/icon/the-staking/eye.png" alt="Block Icon" />
