<template>
  <div
    class="col-start-1 col-span-full row-start-1 row-span-1 bg-black rounded-md grid grid-cols-6 p-[2px] items-center"
  >
    <img
    ...
    >
      <span class="text-xs text-gray-800 font-semibold">32</span>
    </div>
  </div>
</template>
