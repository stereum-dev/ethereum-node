<template>
  <div
    class="w-full col-start-1 col-span-full row-start-3 row-span-1 grid grid-cols-6 items-center p-[1px]"
  ...
  >
    <div class="h-full col-start-1 col-end-3 self-center grid grid-cols-3 justify-center items-center gap-1 px-[2px]">
      <img class="col-start-1 col-span-1 w-3" src="/img/icon/staking-page-icons/keyIcon.png" alt="Block Icon" @mousedown.prevent />
    ...
    >
      <span class="w-full text-[10px] text-green-600 font-medium text-center">{{ totalKeys }}</span>
    </div>
  </div>
</template>
