<template>
  <div
    class="col-start-1 col-span-full row-start-5 row-span-1 self-center border border-gray-500 rounded-full grid grid-cols-6 justify-center items-center bg-zinc-600"
  >
