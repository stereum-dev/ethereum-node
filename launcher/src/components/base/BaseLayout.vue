<template>
  <div
    class="flex flex-col justify-between box-border items-center w-screen h-screen border-2 border-slate-500 rounded-lg z-30"
  >
    <div
    ...
    <div class="flex justify-center items-center w-full h-full max-h-[488px] bg-[#33393E]">
      <slot></slot>
    </div>
